...
public class ABmanager : BaseSingletonWithoutMono<ABmanager>
{
    ...
    {
        BaseMono.Instance.StartCoroutine(ReallyLoadResAsync<T>(abName, resName, callBack, isSync));
    }
    //正儿八经的 协程函数
    ...
    {
        BaseMono.Instance.StartCoroutine(ReallyLoadResAsync(abName, resName, type, callBack, isSync));
    }
    ...
    {
        BaseMono.Instance.StartCoroutine(ReallyLoadResAsync(abName, resName, callBack, isSync));
    }
    ...
    public void ClearAB()
    {
        ...
        BaseMono.Instance.StopAllCoroutines();
