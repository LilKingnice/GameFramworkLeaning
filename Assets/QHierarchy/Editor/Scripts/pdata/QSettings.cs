...
namespace qtools.qhierarchy.pdata
{
    ...
    public class QSettings
    {
        ...
        private QSettings()
        {
            ...
            initSetting(QSetting.StaticShowDuringPlayMode, true);
            ...
            initSetting(QSetting.RendererShow, true);
            initSetting(QSetting.RendererShowDuringPlayMode, true);

            initSetting(QSetting.PrefabShow, true);
            ...
            initSetting(QSetting.ChildrenCountShow, true);
            initSetting(QSetting.ChildrenCountShowDuringPlayMode, true);
            initSetting(QSetting.ChildrenCountLabelSize, (int)QHierarchySize.Big);
            initSetting(QSetting.ChildrenCountLabelColor, "49FF00", "FF333333");
            ...
            initSetting(QSetting.ComponentsShow, true);
            initSetting(QSetting.ComponentsShowDuringPlayMode, true);
            initSetting(QSetting.ComponentsIconSize, (int)QHierarchySizeAll.Big);
